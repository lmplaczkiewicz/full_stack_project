...
var removeLocation = function removeLocation(data) {
  return $.ajax({
    url: config.apiOrigin + '/locations/' + data,
    method: 'DELETE',
    headers: {
...
var updateLocation = function updateLocation(locationId, data) {
  return $.ajax({
...
var showCompanies = function showCompanies() {
  return $.ajax({
...
var createCompany = function createCompany(data) {
  return $.ajax({
    url: config.apiOrigin + '/companies',
    method: 'POST',
    headers: {
...
var removeCompany = function removeCompany(data) {
  return $.ajax({
...
var updateCompany = function updateCompany(companyId, data) {
  return $.ajax({
...
var getLocations = function getLocations(event) {
  ...
  api.show().then(ui.getLocationsSuccess)
  ...
  .catch(ui.getLocationsFailure).then(function () {
...
var getLocationsNoButton = function getLocationsNoButton(event) {
  api.show().then(ui.getLocationsSuccess)
  // Enables delete button function after loading of content, probably keep it on find location as well. Probably move it to it's own function
  .catch(ui.getLocationsFailure).then(function () {
    $('.removeButton').on('click', deleteLocation);
...
var findLocationAddButton = function findLocationAddButton() {
  $('.removeButton').on('click', deleteLocation);
  $('.updateButton').on('submit', updateLocation);
};

var deleteLocation = function deleteLocation(event) {
  event.preventDefault();
  var locationId = event.target.getAttribute('data-id');
  api.removeLocation(locationId).then(ui.deleteLocationSuccess).then(getLocationsNoButton).catch(ui.deleteLocationFailure);
};

var updateLocation = function updateLocation(event) {
  event.preventDefault();
  var locationId = event.target.getAttribute('data-id');
  var data = getFormFields(event.target);
  api.updateLocation(locationId, data).then(ui.updateLocationSuccess).then(getLocationsNoButton).catch(ui.updateLocationFailure);
};

var singleLocation = function singleLocation(data) {
...
var findLocation = function findLocation(event) {
  event.preventDefault();
  var findData = getFormFields(event.target);
  var locationId = singleLocation(findData.locations.Id);
  // const userId = store.user.id
  api.find(locationId).then(ui.findLocationSuccess).then(findLocationAddButton).catch(ui.findLocationFailure);
};

var createLocation = function createLocation(event) {
  event.preventDefault();
  var data = getFormFields(this);
  // const userId = store.user.id
  api.create(data).then(ui.createLocationSuccess).then(getLocationsNoButton).catch(ui.createLocationFailure);
};

var getCompanies = function getCompanies(event) {
  event.preventDefault();
  // const userId = store.user.id
  api.showCompanies().then(ui.getCompaniesSuccess)
  // Enables delete button function after loading of content, probably keep it on find location as well. Probably move it to it's own function
  .catch(ui.getCompaniesFailure).then(function () {
...
var getCompaniesNoButton = function getCompaniesNoButton(event) {
  api.showCompanies().then(ui.getCompaniesSuccess)
  // Enables delete button function after loading of content, probably keep it on find location as well. Probably move it to it's own function
  .catch(ui.getCompaniesFailure).then(function () {
    $('.removeCompanyButton').on('click', deleteCompany);
...
var deleteCompany = function deleteCompany(event) {
  event.preventDefault();
  var companyId = event.target.getAttribute('data-id');
  api.removeCompany(companyId).then(ui.deleteCompanySuccess).then(getCompaniesNoButton).catch(ui.deleteCompanyFailure);
};

var updateCompany = function updateCompany(event) {
  event.preventDefault();
  var companyId = event.target.getAttribute('data-id');
  var data = getFormFields(event.target);
  api.updateCompany(companyId, data).then(ui.updateCompanySuccess).then(getCompaniesNoButton).catch(ui.updateCompanyFailure);
};

var createCompany = function createCompany(event) {
  event.preventDefault();
  var data = getFormFields(this);
  // const userId = store.user.id
  api.createCompany(data).then(ui.createCompanySuccess).then(getCompaniesNoButton).catch(ui.createCompanyFailure);
};

var onSignIn = function onSignIn(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(getLocationsNoButton).then(getCompaniesNoButton).catch(ui.signInFailure);
};
...
var store = __webpack_require__(3);
var showLocationTemplate = __webpack_require__(17);
var showCompanyTemplate = __webpack_require__(34);
var api = __webpack_require__(6);
...
var getLocationsData = function getLocationsData() {
  api.show().then(getLocationsDataSuccess).catch(getLocationsDataFailure);
};
...
var getLocationsSuccess = function getLocationsSuccess(data) {
  var showLocationHtml = showLocationTemplate({ locations: data.locations });
...
var findLocationSuccess = function findLocationSuccess(data) {
  var showLocationHtml = showLocationTemplate({ locations: data });
  $('#contentDisplay').html(showLocationHtml);
...
var findLocationFailure = function findLocationFailure() {
...
var getLocationsDataSuccess = function getLocationsDataSuccess(data) {
  store.locations = data.locations;
};

var getLocationsDataFailure = function getLocationsDataFailure() {
...
var createLocationSuccess = function createLocationSuccess() {
...
var getCompaniesSuccess = function getCompaniesSuccess(data) {
  var showCompanyHtml = showCompanyTemplate({ companies: data.companies });
...
var getCompaniesFailure = function getCompaniesFailure() {
...
var createCompanySuccess = function createCompanySuccess() {
...
var createCompanyFailure = function createCompanyFailure() {
...
var getCompaniesData = function getCompaniesData() {
  api.show().then(getCompaniesDataSuccess).catch(getCompaniesDataFailure);
};

var getCompaniesDataSuccess = function getCompaniesDataSuccess(data) {
  store.locations = data.locations;
};

var getCompaniesDataFailure = function getCompaniesDataFailure() {
...
var updateCompanySuccess = function updateCompanySuccess(data) {
  $('#companyDisplay').empty();
  $('body').removeClass('modal-open');
  $('.modal-backdrop').remove();
...
var updateCompanyFailure = function updateCompanyFailure() {
  $('.errorTarget').addClass('shake');
...
module.exports = {
  ...
  findLocationSuccess: findLocationSuccess,
  findLocationFailure: findLocationFailure,
  getLocationsDataSuccess: getLocationsDataSuccess,
  getLocationsDataFailure: getLocationsDataFailure,
  ...
  createCompanyFailure: createCompanyFailure,
  getCompaniesSuccess: getCompaniesSuccess,
  getCompaniesFailure: getCompaniesFailure,
  updateCompanySuccess: updateCompanySuccess,
  updateCompanyFailure: updateCompanyFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<table class=\"locationHolder\" data-id=\""
    ...
    + "</caption>\n      <thead>\n        <tr>\n          <th scope=\"col\">Insured Objects</th>\n          <th scope=\"col\">Company</th>\n          <th scope=\"col\">Business Type</th>\n          <th scope=\"col\">Inspection Date</th>\n          <th scope=\"col\">Total Claims</th>\n          <th scope=\"col\"><div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"updateButton\" id=\"updateHandleButton\"><button  data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"updateHandleButton btn-primary\" data-toggle=\"modal\" data-target=\"#updateLocationModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update Location</button>\n            <form data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"dataAccess updateLocation\" id=\"updateLocationId"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <div class=\"modal fade errorTarget\" id=\"updateLocationModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n              <div class=\"modal-dialog\" role=\"document\">\n                <div class=\"modal-content handlebarModal\">\n                  <div class=\"modal-header\">\n                    <h3 class=\"modal-title\" id=\"updateModalLabel\">Update Location</h3>\n                  </div>\n                  <div class=\"modal-body\">\n                    <div class=\"errorUpdateLocation\"></div>\n                    <div class=\"form-group\">\n                    <label>Address</label>\n                    <input type=\"text\" class=\"form-control\" name=\"location[address]\" id=\"addressUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.address : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <!-- <div class=\"form-group\">\n                    <label>Business Type</label>\n                    <input type=\"text\" class=\"form-control\" name=\"location[business]\" id=\"businessUpdate\" placeholder=\"Enter Business Type\">\n                    </div> -->\n                    <div class=\"form-group\">\n                      <label for=\"exampleSelect1\">Business Type</label>\n                      <select class=\"form-control\" id=\"exampleSelect1\" name=\"location[business]\">\n                        <option>Service</option>\n                        <option>Merchandising</option>\n                        <option>Manufacturing</option>\n                        <option>Hybrid</option>\n                        <option>Other</option>\n                      </select>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Objects Insured</label>\n                    <input type=\"number\" min=\"0\" step=\"1\" class=\"form-control\" name=\"location[objects]\" id=\"unitUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.objects : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Company</label>\n                    <input type=\"text\" class=\"form-control\" name=\"location[company]\" id=\"companyUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.company : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Total Claims</label>\n                    <input type=\"number\" min=\"0\" step=\"1\" class=\"form-control\" name=\"location[claims]\" id=\"complianceUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.claims : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Inspection Date</label>\n                    <input pattern=\"\\d{4}-\\d{1,2}-\\d{1,2}\" type=\"date\" class=\"form-control\" name=\"location[inspection]\" id=\"inspectionUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.inspection : stack1), depth0))
    + "\" required>\n                    </div>\n\n                  <div class=\"modal-footer\">\n                    <button type=\"button\" class=\"btn-danger modalCloseButton\" data-dismiss=\"modal\">Close</button>\n                    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn-primary updateFormButton modalConfirmButton\" id=\"updateFormButton\">Update Location</button>\n                  </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </form>\n        </div>\n      </th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.objects : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.company : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.business : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.inspection : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.claims : stack1), depth0))
    + "</td>\n          <td scope=\"col\"><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"removeButton btn-danger\">Remove Location</button></td>\n        </tr>\n      </tbody>\n  </table>\n\n\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<table class=\"companyHolder\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n<caption>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</caption>\n      <thead>\n        <tr>\n          <th scope=\"col\">Risk Manager</th>\n          <th scope=\"col\">Phone Number</th>\n          <th scope=\"col\">Email</th>\n          <th scope=\"col\"><div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"updateFormCompanyButton\" id=\"updateHandleButton\"><button  data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"updateHandleButton btn-primary\" data-toggle=\"modal\" data-target=\"#updateCompanyModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update Company</button>\n            <form data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"dataAccess updateCompany\" id=\"updateCompanyId"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <div class=\"modal fade errorTarget\" id=\"updateCompanyModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n              <div class=\"modal-dialog\" role=\"document\">\n                <div class=\"modal-content handlebarModal\">\n                  <div class=\"modal-header\">\n                    <h3 class=\"modal-title\" id=\"updateModalLabel\">Update Company</h3>\n                  </div>\n                  <div class=\"modal-body\">\n                    <div class=\"errorUpdateCompany\"></div>\n                    <div class=\"form-group\">\n                    <label>Company Name</label>\n                    <input type=\"text\" class=\"form-control\" name=\"company[name]\" id=\"managerUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <!-- <div class=\"form-group\">\n                    <label>Business Type</label>\n                    <input type=\"text\" class=\"form-control\" name=\"company[business]\" id=\"businessUpdate\" placeholder=\"Enter Business Type\">\n                    </div> -->\n\n                    <div class=\"form-group\">\n                    <label>Risk Manager</label>\n                    <input type=\"text\" class=\"form-control\" name=\"company[manager]\" id=\"managerUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.manager : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Phone Number</label>\n                    <input type=\"text\" class=\"form-control\" name=\"company[phone]\" id=\"phoneUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone : stack1), depth0))
    + "\" required>\n                    </div>\n\n                    <div class=\"form-group\">\n                    <label>Email</label>\n                    <input type=\"email\" class=\"form-control\" name=\"company[email]\" id=\"emailRiskUpdate\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
    + "\" required>\n                    </div>\n\n                  <div class=\"modal-footer\">\n                    <button type=\"button\" class=\"btn-danger modalCloseButton\" data-dismiss=\"modal\">Close</button>\n                    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn-primary updateFormCompanyButton modalConfirmButton\" id=\"updateFormCompanyButton\">Update Company</button>\n                  </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </form>\n        </div>\n      </th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.manager : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone : stack1), depth0))
    + "</td>\n          <td scope=\"col\">"
    ...
    + "</td>\n          <td scope=\"col\"><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"removeCompanyButton btn-danger\">Remove Company</button></td>\n        </tr>\n      </tbody>\n  </table>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.companies : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
